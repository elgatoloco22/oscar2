...
:root {
  ...
  --font-family-monospace: SFMono-Regular, Menlo, Monaco, Consolas, "Raleway", "Courier New", monospace; }

.voyalmar {
  color: #3c3b3b;
  font-family: "NORDIC", Helvetica, sans-serif;
  font-weight: 900;
...
h1, h2, h3, h4, h5, h6,
.h1, .h2, .h3, .h4, .basket-items .price_color, .product_pod .price_color, .h5, .product_pod h3, .h6 {
  margin-bottom: 0.5rem;
  font-weight: 500;
  line-height: 1.2; }
...
h4, .h4, .basket-items .price_color, .product_pod .price_color {
  font-size: 1.125rem; }
